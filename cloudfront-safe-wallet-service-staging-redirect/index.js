...
exports.handler = (event, context, callback) => {
  ...
  // if uri is like /v10/wallet non-extension files, then return /v10/index.html ^\/v[0-9][0-9]*\.[0-9][0-9]*\.[0-9][0-9]*\/[^\.]*$
  // if uri is like /v10 or /v10/, then return /v10/index.html ^\/v[0-9][0-9]*\.[0-9][0-9]*\.[0-9][0-9]*[\/]?$
  // if uri is like /embed.min.js *(js|css|png|PNG|svg|html|jpg|JPG|jpeg|JPEG), then return /${version}/embed.min.js ^\/..*\.(js|css|png|PNG|svg|html|jpg|JPG|jpeg|JPEG)$
  // if uri is like /wallet or /wallet/ , then return /${version}/index.html ^\/[^\.]*$
