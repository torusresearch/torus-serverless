...
const GLOBAL_VERSION = "buildVersion";
...
exports.handler = (event, context, callback) => {
  ...
  // if uri is like /v10/wallet non-extension files, then return app.tor.us/v10/index.html ^\/v[0-9][0-9]*\/[^\.]*$
  // if uri is like /v10 or /v10/, then return app.tor.us/v10/index.html ^\/v[0-9][0-9]*[\/]?$
